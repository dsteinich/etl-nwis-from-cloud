...
@Component
public class TransformGwLevelDateTimeAccuracy {
	...
	@Bean
	public JdbcCursorItemReader<GwReflist> gwReflistGwLevelDateTimeAccuracyReader() {
		return new JdbcCursorItemReaderBuilder<GwReflist>()
				.dataSource(dataSourceNwis)
				.name("gwReflistGwLevelDateTimeAccuracy")
				.preparedStatementSetter(new PreparedStatementSetter() {
					public void setValues(PreparedStatement preparedStatement) throws SQLException {
						preparedStatement.setString(1, GwReflist.GW_LEVEL_DATE_TIME_ACCURACY);
					}
				})
	...
	@Bean
	public BasicLookupProcessor gwLevelDateTimeAccuracyProcessor() {
		return new BasicLookupProcessor();
	}

	@Bean
	public JdbcBatchItemWriter<BasicLookup> gwLevelDateTimeAccuracyWriter() {
		return new JdbcBatchItemWriterBuilder<BasicLookup>()
				...
				.sql(String.format(GwReferenceCode.INSERT_GENERIC_LOOKUP, BasicLookup.GW_LEVEL_DATE_TIME_ACCURACY))
				.dataSource(dataSourceNwis)
				.build();
	}
}
